...
if __name__ == '__main__':
    ...
    for xml_filename in listdir(args.xml_directory):
        ...
        #print "top cleanses",top_cleanses
        #print "top damage",top_damage
        #print "top stab",top_stab
    ...
    i = 0
    while i < min(len(sorted_top_strips), 3):
    ...
    i = 0
    while i < min(len(sorted_top_stab), 3):
    ...
    # top dist = com -> start at 1
    i = 1
    while i < min(len(sorted_top_dist), 4):
