...
if __name__ == '__main__':
    ...
    for stat in config.stats_to_compute:
        ...
        if stat == 'dist':
            ...
            top_average_players[stat] = get_and_write_sorted_average(players, config, num_used_fights, stat, output)
        else:
    ...
    for stat in config.stats_to_compute:
        if stat == 'dist':
            ...
            write_stats_xls(players, top_average_players[stat], stat, args.xls_output_filename)
