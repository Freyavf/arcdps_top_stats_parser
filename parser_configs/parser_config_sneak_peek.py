#    This file contains the configuration for computing the sneak peek of top stats in arcdps logs as parsed by Elite Insights.
...
num_players_considered_top = {'dmg': 3, 'rips': 3, 'stab': 5, 'cleanses': 3, 'heal': 5, 'dist': 5, 'deaths': 5, 'kills': 5}
